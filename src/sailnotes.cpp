...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<NotificationManager>("harbour.sailnotes.notificationManager", 1, 0, "NotificationManager");
    qmlRegisterType<EvernoteSynchronizer>("harbour.sailnotes.evernoteSynchronizer", 1, 0, "EvernoteSynchronizer");
