...
qevercloud::AsyncResult::AsyncResult(QString url, QByteArray postData,
                                     qevercloud::AsyncResult::ReadFunctionType readFunction,
                                     bool autoDelete, QObject *parent) : QObject(parent)
{
    postData_ = postData;
    readFunction_ = readFunction;
    autoDelete_ = autoDelete;
    request_ = createEvernoteRequest(url);
    QMetaObject::invokeMethod(this, "start", Qt::QueuedConnection);
}

qevercloud::AsyncResult::AsyncResult(QNetworkRequest request, QByteArray postData,
                                     qevercloud::AsyncResult::ReadFunctionType readFunction,
                                     bool autoDelete, QObject *parent) : QObject(parent)
{
    request_ = request;
